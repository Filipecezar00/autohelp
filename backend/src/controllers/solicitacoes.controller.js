...
async function criarSolicitacao(req, res) {
  try {
    ...
    console.log("prestadorId recebido:", prestadorId);
    console.log("prestadoresEncontrados:", prestadoresEncontrados);
    console.log(
      "usuario_id do prestador:",
      prestadoresEncontrados[0]?.usuario_id,
    );
